...
mod erc20 {
    ...
    impl ::ink::reflect::DispatchableConstructorInfo<0xED4B9D1B_u32> for Erc20 {
        type Input = ();
        type Output = Self;
        type Storage = Erc20;
        type Error = <::ink::reflect::ConstructorOutputValue<
        ...
        const IS_RESULT: ::core::primitive::bool = <::ink::reflect::ConstructorOutputValue<
            Self,
        > as ::ink::reflect::ConstructorOutput<Erc20>>::IS_RESULT;
        const CALLABLE: fn(Self::Input) -> Self::Output = |_| { Erc20::default() };
        const PAYABLE: ::core::primitive::bool = false;
        const SELECTOR: [::core::primitive::u8; 4usize] = [
            0xED_u8,
            0x4B_u8,
        ...
        impl ::ink::reflect::DecodeDispatch for __ink_ConstructorDecoder {
                ...
                I: ::scale::Input,
            {
                const CONSTRUCTOR_0: [::core::primitive::u8; 4usize] = <Erc20 as ::ink::reflect::DispatchableConstructorInfo<
                    0x9BAE9D5E_u32,
                >>::SELECTOR;
                const CONSTRUCTOR_1: [::core::primitive::u8; 4usize] = <Erc20 as ::ink::reflect::DispatchableConstructorInfo<
                    0xED4B9D1B_u32,
                >>::SELECTOR;
                        ...
                        if {
                            false
                                ...
                                || {
                                    ...
                                    let constructor_1 = <Erc20 as ::ink::reflect::DispatchableConstructorInfo<
                                        0xED4B9D1B_u32,
                                    >>::PAYABLE;
                                    constructor_1
                                }
    ...
    const _: () = {
        ...
        impl Erc20 {
            ...
            pub fn transfer_helper(
                ...
                if value > balance_form {
                    return Err(Error::BalanceTooLow);
                }
                self.balances.insert(from, &(balance_form - value));
